...
<?php 
	...
	echo '<figure class="cmsmasters_quote_image ' . (($quote_image == '') ? 'cmsmasters_quote_placeholder' : '') . '">' . 
		(($quote_image != '') ? wp_get_attachment_image(strstr($quote_image, '|', true), 'cmsmasters-square-thumb') : '' ) . 
	'</figure>';
