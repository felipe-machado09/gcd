...
if ($query->have_posts()) : 
	...
	$out .= "<div class=\"cmsmasters_posts_slider" . 
		(($post_type == 'post') ? ' cmsmasters_slide_nav ' : '') . 
		(($post_type == 'post') ? ' cmsmasters_slide_post ' : ' cmsmasters_slide_project ') . 
		(($controls == true) ? ' cmsmasters_control ' : '') . 
	...
	">
		<div" . 
			...
			" data-navigation=\"" . (($controls == true) ? 'true' : 'false') . "\"" . 
