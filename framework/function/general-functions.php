...
/* Register CSS Styles */
function magazilla_register_css_styles() {
	if (!is_admin()) {
		global $post, 
			$wp_styles;
		...
		wp_enqueue_style('magazilla-theme-style', get_template_directory_uri() . '/style.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('gcd-theme-style', get_template_directory_uri() . '/gcd.css', array(), '1.0.1', 'screen, print');
		
		wp_enqueue_style('magazilla-style', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/style.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('magazilla-adaptive', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/adaptive.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('magazilla-retina', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/retina.css', array(), '1.0.0', 'screen');
		
		
		if (is_rtl()) {
			wp_enqueue_style('magazilla-rtl', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/rtl.css', array(), '1.0.0', 'screen');
		}
		...
		// iLightBox skins
		$ilightbox_skin = $cmsmasters_option['magazilla' . '_ilightbox_skin'];
		...
		if (is_dir($style_dir) && get_option('cmsmasters_style_exists_' . 'magazilla')) {
			$cmsmasters_styles_dir = $upload_dir['baseurl'] . '/cmsmasters_styles/';
		}
		
		
		wp_enqueue_style('magazilla-fonts-schemes', $cmsmasters_styles_dir . 'magazilla' . '.css', array(), '1.0.0', 'screen');
	}
}

add_action('wp_enqueue_scripts', 'magazilla_register_css_styles');



/* Register JS Scripts */
function magazilla_register_js_scripts() {
	global $post;
	...
	$cmsmasters_localize_array = array( 
		...
		'project_puzzle_proportion' => 			magazilla_project_puzzle_proportion(), 
		'gmap_api_key' => 						$cmsmasters_option['magazilla' . '_gmap_api_key'], 
		'gmap_api_key_notice' => 				esc_html__('Please add your Google Maps API key', 'magazilla'), 
		'gmap_api_key_notice_link' => 			esc_html__('read more how', 'magazilla'), 
		'primary_color' => 						$cmsmasters_option['magazilla' . '_default_link'], 
		'ilightbox_skin' => 					$cmsmasters_option['magazilla' . '_ilightbox_skin'], 
		'ilightbox_path' => 					$cmsmasters_option['magazilla' . '_ilightbox_path'], 
		'ilightbox_infinite' => 				$cmsmasters_option['magazilla' . '_ilightbox_infinite'], 
		'ilightbox_aspect_ratio' => 			$cmsmasters_option['magazilla' . '_ilightbox_aspect_ratio'], 
		'ilightbox_mobile_optimizer' => 		$cmsmasters_option['magazilla' . '_ilightbox_mobile_optimizer'], 
		'ilightbox_max_scale' => 				$cmsmasters_option['magazilla' . '_ilightbox_max_scale'], 
		'ilightbox_min_scale' => 				$cmsmasters_option['magazilla' . '_ilightbox_min_scale'], 
		'ilightbox_inner_toolbar' => 			$cmsmasters_option['magazilla' . '_ilightbox_inner_toolbar'], 
		'ilightbox_smart_recognition' => 		$cmsmasters_option['magazilla' . '_ilightbox_smart_recognition'], 
		'ilightbox_fullscreen_one_slide' => 	$cmsmasters_option['magazilla' . '_ilightbox_fullscreen_one_slide'], 
		'ilightbox_fullscreen_viewport' => 		$cmsmasters_option['magazilla' . '_ilightbox_fullscreen_viewport'], 
		'ilightbox_controls_toolbar' => 		$cmsmasters_option['magazilla' . '_ilightbox_controls_toolbar'], 
		'ilightbox_controls_arrows' => 			$cmsmasters_option['magazilla' . '_ilightbox_controls_arrows'], 
		'ilightbox_controls_fullscreen' => 		$cmsmasters_option['magazilla' . '_ilightbox_controls_fullscreen'], 
		'ilightbox_controls_thumbnail' => 		$cmsmasters_option['magazilla' . '_ilightbox_controls_thumbnail'], 
		'ilightbox_controls_keyboard' => 		$cmsmasters_option['magazilla' . '_ilightbox_controls_keyboard'], 
		'ilightbox_controls_mousewheel' => 		$cmsmasters_option['magazilla' . '_ilightbox_controls_mousewheel'], 
		'ilightbox_controls_swipe' => 			$cmsmasters_option['magazilla' . '_ilightbox_controls_swipe'], 
		'ilightbox_controls_slideshow' => 		$cmsmasters_option['magazilla' . '_ilightbox_controls_slideshow'], 
		'ilightbox_close_text' => 				esc_html__('Close', 'magazilla'), 
		'ilightbox_enter_fullscreen_text' => 	esc_html__('Enter Fullscreen (Shift+Enter)', 'magazilla'), 
		'ilightbox_exit_fullscreen_text' => 	esc_html__('Exit Fullscreen (Shift+Enter)', 'magazilla'), 
		'ilightbox_slideshow_text' => 			esc_html__('Slideshow', 'magazilla'), 
		'ilightbox_next_text' => 				esc_html__('Next', 'magazilla'), 
		'ilightbox_previous_text' => 			esc_html__('Previous', 'magazilla'), 
		'ilightbox_load_image_error' => 		esc_html__('An error occurred when trying to load photo.', 'magazilla'), 
		'ilightbox_load_contents_error' => 		esc_html__('An error occurred when trying to load contents.', 'magazilla'), 
		'ilightbox_missing_plugin_error' => 	esc_html__("The content your are attempting to view requires the <a href='{pluginspage}' target='_blank'>{type} plugin<\/a>.", 'magazilla') 
	);
	...
	wp_enqueue_script('magazilla-script', get_template_directory_uri() . '/js/jquery.script.js', array('jquery'), '1.0.0', true);
	
	wp_localize_script('magazilla-script', 'cmsmasters_script', $cmsmasters_localize_array);
	
	wp_enqueue_script('magazilla-theme-script', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/js/jquery.theme-script.js', array('jquery', 'magazilla-script'), '1.0.0', true);
	
	wp_enqueue_script('twitter', get_template_directory_uri() . '/js/jquery.tweet.min.js', array('jquery'), '1.3.1', true);

	
	wp_enqueue_script('smooth-sticky', get_template_directory_uri() . '/js/smooth-sticky.min.js', array(), '1.0.0', true);
	...
	if ( 
		...
		isset($cmsmasters_option['magazilla' . '_gmap_api_key']) && 
		$cmsmasters_option['magazilla' . '_gmap_api_key'] != '' 
	) {
		wp_enqueue_script('gMapAPI', '//maps.googleapis.com/maps/api/js?key=' . $cmsmasters_option['magazilla' . '_gmap_api_key'], array('jquery'), '1.0.0', true);
	...
	$cmsmasters_custom_js = stripslashes($cmsmasters_option['magazilla' . '_custom_js']);
	
	wp_add_inline_script('magazilla-script', $cmsmasters_custom_js);
	
	
	if (CMSMASTERS_DEVELOPER_MODE) {
		magazilla_regenerate_styles();
	}
}

add_action('wp_enqueue_scripts', 'magazilla_register_js_scripts');


/* Fonts Generate Function */
if (!function_exists('magazilla_theme_fonts_generate')) {

function magazilla_theme_fonts_generate() {
	$cmsmasters_option = magazilla_get_global_options();
	...
	foreach ($font_fields as $font_field) {
		$font_option = 'magazilla' . '_' . $font_field . '_font_google_font';
...
add_action('wp_enqueue_scripts', 'magazilla_theme_fonts_generate');
add_action('enqueue_block_editor_assets', 'magazilla_theme_fonts_generate');
...
function cmsmasters_theme_font($fonts, $font_name = '') {
	...
	if ( 
		...
		if ($local_fonts != '' && $font_name == '') {
			wp_add_inline_style('magazilla-style', $local_fonts);
		}
		...
		if ($web_fonts != '') {
			...
			if (
				isset($cmsmasters_option['magazilla' . '_google_web_fonts_subset']) && 
				is_array($cmsmasters_option['magazilla' . '_google_web_fonts_subset'])
			) {
				$web_fonts_subset_array = $cmsmasters_option['magazilla' . '_google_web_fonts_subset'];
			} else {
...
function magazilla_get_google_font($font) {
	if ($font != '') {
		if (strpos($font, ':')) {
...
function magazilla_the_widgets_init() {
	...
	register_sidebar(
        array(
            'name' => esc_html__('Sidebar', 'magazilla'), 
            'id' => 'sidebar_default', 
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars till you don\'t use custom sidebar. To display the sidebar please choose the Right or Left Layout Type in the Theme Settings - General - Content options.', 'magazilla'), 
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Bottom Sidebar', 'magazilla'), 
            'id' => 'sidebar_bottom', 
            'description' => esc_html__('Widgets in this area will be shown at the bottom of middle block below the content and middle sidebar, but above footer. To display Bottom Sidebar please enable it in the Theme Settings - General - Content - Bottom Sidebar Visibility by Default. You can also display it on concrete page in the Page Layout options.', 'magazilla'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Archive Sidebar', 'magazilla'), 
            'id' => 'sidebar_archive', 
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars on archives pages. To display the sidebar please choose the Right or Left Layout Type in the Theme Settings - General - Content options.', 'magazilla'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Search Sidebar', 'magazilla'), 
            'id' => 'sidebar_search', 
            'description' => esc_html__('Widgets in this area will be shown in left or right sidebar on search page. To display the sidebar please choose the Right or Left Layout Type in the Theme Settings - General - Content options.', 'magazilla'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
	...
	if (isset($cmsmasters_option['magazilla' . '_sidebar']) && sizeof($cmsmasters_option['magazilla' . '_sidebar']) > 0) {
		foreach ($cmsmasters_option['magazilla' . '_sidebar'] as $sidebar) {
			register_sidebar(array( 
				'name' => $sidebar, 
				'id' => generateSlug($sidebar, 45), 
				'description' => esc_html__('Custom sidebar created with cmsmasters admin panel.', 'magazilla'), 
				'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
				'after_widget' => '</aside>', 
...
add_action('widgets_init', 'magazilla_the_widgets_init');



/* Register Showing Home Page on Default WordPress Pages Menu */
function magazilla_page_menu_args($args) {
	$args['show_home'] = true;
...
add_filter('wp_page_menu_args', 'magazilla_page_menu_args');
...
if (function_exists('add_theme_support')) {
	...
	function magazilla_add_post_type_support_project($post) {
	...
	add_action('load-post.php', 'magazilla_add_post_type_support_project');
	
	add_action('load-post-new.php', 'magazilla_add_post_type_support_project');
	...
	add_filter('image_size_names_choose', 'magazilla_select_image_size');
}



/* Add Image Thumbnails Size to the List */
function magazilla_select_image_size($sizes) {
	$thumbnail_list = cmsmasters_image_thumbnail_list();
...
function magazilla_add_editor_styles() {
...
if (version_compare($cmsmasters_wp_version, '5', '<') && !function_exists('is_gutenberg_page')) {
	add_action('init', 'magazilla_add_editor_styles');
}



/* Register Removing 'More Text' From Excerpt */
function magazilla_new_excerpt_more($more) {
	return '...';
}

add_filter('excerpt_more', 'magazilla_new_excerpt_more');
...
function magazilla_excerpt($length = 55, $show = true) {
	if ($show) {
...
function magazilla_post_author_archive($query) {
...
add_action('pre_get_posts', 'magazilla_post_author_archive');



/* Check Row p Wrapper */
function magazilla_rowcheck($content) {
...
function magazilla_generate_front_css() {
	$shortcodes_css = get_post_meta(get_the_ID(), 'cmsmasters_shortcodes_custom_css', true);
	
	
	wp_add_inline_style('magazilla-retina', $shortcodes_css);
}

add_action('wp_enqueue_scripts', 'magazilla_generate_front_css');
...
function magazilla_add_global_icons() {
	...
	if ($wp_filesystem) {
		...
		update_option('cmsmasters_' . 'magazilla' . '_icons', serialize($arr));
		
		update_option('cmsmasters_' . 'magazilla' . '_icons_custom', serialize($arr_custom));
	}
}
...
function cmsmasters_composer_icons() {
	...
	if ( 
		...
		$icons = get_option('cmsmasters_' . 'magazilla' . '_icons');
		
		$icons_custom = get_option('cmsmasters_' . 'magazilla' . '_icons_custom');
		...
		} elseif (wp_script_is('magazilla-lightbox-js', 'queue')) {
			wp_add_inline_script('magazilla-lightbox-js', $out, 'before');
		}
	}
}
...
function magazilla_regenerate_styles() {
	$custom_css_fonts = magazilla_theme_fonts();
	
	$custom_css_colors_primary = magazilla_theme_colors_primary();
	
	$custom_css_colors_secondary = magazilla_theme_colors_secondary();
	
	
	$custom_css = $custom_css_fonts . $custom_css_colors_primary . $custom_css_colors_secondary;
	
	
	magazilla_write_styles($custom_css);
}
...
function magazilla_write_styles($styles, $filename = '') {
	$upload_dir = wp_upload_dir();
	...
	$is_dir = magazilla_create_folder($style_dir);
	
	
	if ($is_dir === false) {
		update_option('cmsmasters_style_dir_writable_' . 'magazilla', 'false');
		
		update_option('cmsmasters_style_exists_' . 'magazilla', 'false');
	...
	$file = trailingslashit($style_dir) . (($filename != '') ? $filename : 'magazilla') . '.css';
	
	
	$created = magazilla_create_file($file, $styles);
	
	
	if ($created === true) {
		update_option('cmsmasters_style_dir_writable_' . 'magazilla', 'true');
		
		update_option('cmsmasters_style_exists_' . 'magazilla', 'true');
	}
}
...
function magazilla_create_folder(&$folder, $addindex = true) {
...
function magazilla_create_file($file, $content = '', $verifycontent = true) {
	global $wp_filesystem;
...
function cmsmasters_get_tweets($username, $count) {
	...
	$numTweets = $count;
	$cacheTime = 1;
	$backupName = 'cmsmasters_' . 'magazilla' . '_tweets_list_backup';
	
	
	$connection = new TwitterOAuth( 
		(($cmsmasters_option['magazilla' . '_api_key'] != '') ? $cmsmasters_option['magazilla' . '_api_key'] : ''), 
		(($cmsmasters_option['magazilla' . '_api_secret'] != '') ? $cmsmasters_option['magazilla' . '_api_secret'] : ''), 
		(($cmsmasters_option['magazilla' . '_access_token'] != '') ? $cmsmasters_option['magazilla' . '_access_token'] : ''), 
		(($cmsmasters_option['magazilla' . '_access_token_secret'] != '') ? $cmsmasters_option['magazilla' . '_access_token_secret'] : '')
	);
...
function magazilla_theme_bg_styles() {
	global $post;
	...
	if ($cmsmasters_option['magazilla' . '_theme_layout'] == 'boxed') {
		...
		if ($cmsmasters_bg_default == 'false') {
			...
			$cmsmasters_bg_col = $cmsmasters_option['magazilla' . '_bg_col'];
			$cmsmasters_bg_img_enable = $cmsmasters_option['magazilla' . '_bg_img_enable'];
			$cmsmasters_bg_img_str = $cmsmasters_option['magazilla' . '_bg_img'];
			$cmsmasters_bg_pos = $cmsmasters_option['magazilla' . '_bg_pos'];
			$cmsmasters_bg_rep = $cmsmasters_option['magazilla' . '_bg_rep'];
			$cmsmasters_bg_att = $cmsmasters_option['magazilla' . '_bg_att'];
			$cmsmasters_bg_size = $cmsmasters_option['magazilla' . '_bg_size'];
		}
	...
	wp_add_inline_style('magazilla-style', $out);
}

add_action('wp_enqueue_scripts', 'magazilla_theme_bg_styles');



/* Get Logo Function */
function magazilla_logo() {
	$cmsmasters_option = magazilla_get_global_options();
	
	
	if ($cmsmasters_option['magazilla' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['magazilla' . '_logo_title'] != '') {
			$blog_title = stripslashes($cmsmasters_option['magazilla' . '_logo_title']);
		} else {
			$blog_title = (get_bloginfo('name')) ? get_bloginfo('name') : 'Magazilla';
		}
		
		
		if ($cmsmasters_option['magazilla' . '_logo_subtitle'] != '') {
			$blog_descr = stripslashes($cmsmasters_option['magazilla' . '_logo_subtitle']);
		} else {
			$blog_descr = (get_bloginfo('description')) ? get_bloginfo('description') : esc_html__('Default Logo Subtitle', 'magazilla');
		}
		...
		echo '<a href="' . esc_url(home_url('/')) . '" title="' . esc_attr($blog_title) . '" class="logo">' . "\n\t" . 
			'<span class="logo_text_wrap">' . 
				...
				($cmsmasters_option['magazilla' . '_logo_subtitle'] ? '<span class="title_text">' . esc_html($blog_descr) . '</span>' : '') . 
			'</span>' . 
		'</a>';
	} else {
		...
		if ($cmsmasters_option['magazilla' . '_logo_url'] == '') {
			...
			$logo_img = explode('|', $cmsmasters_option['magazilla' . '_logo_url']);
			...
			if ($cmsmasters_option['magazilla' . '_logo_url_retina'] != '') {
				$logo_img_retina = explode('|', $cmsmasters_option['magazilla' . '_logo_url_retina']);
...
/* Logo Styles */
function magazilla_theme_logo_styles() {
	$cmsmasters_option = magazilla_get_global_options();
	...
	if ($cmsmasters_option['magazilla' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['magazilla' . '_logo_custom_color']) {
			$out .= "
				#header a.logo span.title {
					" . cmsmasters_color_css('color', $cmsmasters_option['magazilla' . '_logo_title_color']) . "
				}
				
				#header a.logo span.title_text {
					" . cmsmasters_color_css('color', $cmsmasters_option['magazilla' . '_logo_subtitle_color']) . "
				}
			";
		}
	} else {
		...
		$header_mid_height = (($cmsmasters_option['magazilla' . '_header_mid_height'] !== '') ? $cmsmasters_option['magazilla' . '_header_mid_height'] : $defaults[$tab]['magazilla' . '_header_mid_height']);
...
add_action('wp_enqueue_scripts', 'magazilla_theme_logo_styles');



/* Get Footer Logo Function */
function magazilla_footer_logo($cmsmasters_option) {
	...
	if ($cmsmasters_option['magazilla' . '_footer_logo_url'] == '') {
		...
		$footer_logo_img = explode('|', $cmsmasters_option['magazilla' . '_footer_logo_url']);
		...
		if ($cmsmasters_option['magazilla' . '_footer_logo_url_retina'] != '') {
			$footer_logo_img_retina = explode('|', $cmsmasters_option['magazilla' . '_footer_logo_url_retina']);
...
function magazilla_social_icons() {
	$out = '';
...
<div class=\"social_wrap\">
	<div class=\"social_wrap_inner\">
		...
		foreach ($cmsmasters_option['magazilla' . '_social_icons'] as $cmsmasters_social_icons) {
...
function magazilla_get_comments($class = false, $show = false, $add_html = false) { 
	$out = '';
	
	if ($add_html) {
		$text = (get_comments_number() == '1') ? esc_html__('comment', 'magazilla') : esc_html__('comments', 'magazilla');
	} else {
		$text = '';
	}
	...
	if (comments_open()) {
		$out .= '<span class="cmsmasters_comments' . ($class ? ' ' . $class : '') . '">' . 
			'<a class="cmsmasters_theme_icon_comment" href="' . esc_url(get_comments_link()) . '" title="' . esc_attr__('Comment on', 'magazilla') . ' ' . esc_attr(get_the_title()) . '">' . 
...
/* Get Category List */
function magazilla_get_the_category_list($cmsmasters_id, $taxonomy, $sep = '', $before = '', $after = '', $taxonomy_class = false) {
...
function magazilla_theme_page_layout_scheme() {
	$cmsmasters_option = magazilla_get_global_options();
	...
	} elseif (CMSMASTERS_TRIBE_EVENTS && tribe_is_event_query() && isset($cmsmasters_option['magazilla' . '_events_layout'])) {
		$cmsmasters_layout = $cmsmasters_option['magazilla' . '_events_layout'];
	} elseif (is_archive() || is_home()) {
		$cmsmasters_layout = $cmsmasters_option['magazilla' . '_archives_layout'];
	} elseif (is_search()) {
		$cmsmasters_layout = $cmsmasters_option['magazilla' . '_search_layout'];
	} else {
		$cmsmasters_layout = $cmsmasters_option['magazilla' . '_other_layout'];
	}
	
	
	if ($cmsmasters_layout == '') {
		$cmsmasters_layout = $cmsmasters_option['magazilla' . '_layout'];
	}
...
/* Return content */
function magazilla_return_content($content) {
	return $content;
}


/* Register Moving 'style' Tags from Shortcodes to Content Start */
function magazilla_global_shortcodes_styles_move($content) {
	return preg_replace("/(?<!['\"])<style.*?>([^`]*?)<\/style>/", '', $content);
}


function magazilla_row_checker($data) {
	$out = magazilla_rowcheck($data);
	
	return $out;
}

add_filter('the_content', 'magazilla_row_checker', 10, 2);
	...
	if( wp_verify_nonce($nonce, 'cmsmasters_ajax_like-nonce') ){
		...
		if ($post_ID != '') {
			...
			if (isset($_COOKIE['like-' . $post_ID]) || count($ipCheck) != 0) {
				...
				if ($add_html == 'true') {
					$text = ($plusLike == '1') ? esc_html__('like', 'magazilla') : esc_html__('likes', 'magazilla');
				} else {
					$text = '';
				}
...
function cmsmasters_ajax_view_callback() {
	...
	if( wp_verify_nonce($nonce, 'cmsmasters_ajax_view-nonce') ){
		...
		if ($post_ID != '') {
			$views = (get_post_meta($post_ID, 'cmsmasters_views', true) != '') ? magazilla_short_number(get_post_meta($post_ID, 'cmsmasters_views', true)) : '0';
...
function cmsmasters_ajax_apply_theme_style_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_apply_theme_style-nonce')) {
		if (isset($_POST['theme_style'])) {
			update_option('cmsmasters_magazilla_theme_style', $_POST['theme_style']);
		}
...
function magazilla_theme_style_change() {
	if (is_string(get_option('cmsmasters_magazilla_theme_style'))) {
		return;
	} else {
		if (!CMSMASTERS_THEME_STYLE_COMPATIBILITY) {
			update_option('cmsmasters_magazilla_theme_style', '');
		}
		
		magazilla_add_global_options();
		
		magazilla_add_global_icons();
		
		magazilla_regenerate_styles();
	}
}

add_action('init', 'magazilla_theme_style_change');
...
function cmsmasters_ajax_reset_settings_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_reset_settings-nonce')) {
		magazilla_add_global_options(true);
...
function cmsmasters_ajax_export_settings_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_export_settings-nonce')) {
		$cmsmasters_global_settings = array( 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_general', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_bg', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_header', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_content', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_footer', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_font_content', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_font_link', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_font_nav', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_font_heading', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_font_other', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_element_sidebar', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_element_icon', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_element_lightbox', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_element_sitemap', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_element_error', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_element_code', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_element_recaptcha', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_single_post', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_single_project', 
			'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_single_profile'
		);
		...
		foreach (magazilla_all_color_schemes_list() as $key => $value) {
			$cmsmasters_global_colors[] = 'cmsmasters_options_' . 'magazilla' . CMSMASTERS_THEME_STYLE . '_color_' . $key;
		}
		...
		print magazilla_return_content($result);
